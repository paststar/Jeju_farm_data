...
if __name__ == "__main__":
    ...
    dataloader = get_dataloader_sep_folder('/home/bang/Desktop/jeju/dataset/제주 월동작물 자동탐지 드론 영상',batch_size=batch_size)

    for step, data in enumerate(dataloader['Training']):
